...
class GetModel{
    ...
    static public function getData($schema, $table, $select, $orderBy, $orderMode,$startAt,$endAt){
       ...
       $selectArray = explode(",",$select);
         ...
         if(empty(Connection::getColumnsData($schema, $table, $selectArray))){
             return null;
         }
        ...
        if(count($relArray)>1){
            ...
            foreach ($relArray as $key=>$value) {
             ...
             ========================================*/
                 ...
                 if(empty(Connection::getColumnsData($schema,$value, ["*"]))){
        ...
        $linkToText = "";
            ...
            if(count($linkToArray)>1){
                ...
                if(count($relArray)>1){
                    ...
                    $sql = "SELECT $select FROM $schema.$relArray[0] $innerJoinText WHERE $linkToArray[0] = :$linkToArray[0] $linkToText";
    ...
    static public function getRelDataSearch($schema, $rel, $type, $nameFk, $select, $linkTo, $search, $orderBy, $orderMode, $startAt, $endAt){
        ...
        if(count($relArray)>1){
            ...
            $sql = "SELECT $select FROM $schema.$relArray[0] $innerJoinText WHERE $linkToArray[0] LIKE '%$searchArray[0]%' $linkToText";
